...
0. If chrome-devtools tools are not available, stop and tell me exactly what is missing (server not started, Chrome not launched with --remote-debugging-port=9222, wrong browser-url/port).
