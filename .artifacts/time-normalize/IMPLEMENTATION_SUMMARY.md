...
- ✅ Job scheduled_* vs line promised_date coexistence
...
3. **Line item scheduled_*:**
   - Per-item scheduling window (optional, more specific than job-level)
   - Empty string converted to null
   - Falls back to job-level scheduled_* if not set

4. **Coexistence:**
   - Job scheduled_* and line promised_date can both exist
...
| Job scheduled_* vs line promised_date distinction | ✅ Verified via coexistence tests |
...
- Job scheduled_* and line promised_date coexist peacefully
