...
describe('Step 12: Interactive Controls & Disabled/Enabled Logic', () => {
  ...
  beforeEach(() => {
    ...
    document.body.innerHTML = `
      <div id="app">
        <!-- New Deal Button -->
        <button data-testid="new-deal-btn">New Deal</button>
    ...
    // JSDOM does not execute inline onClick="..." attributes.
    // Wire lightweight handlers so our click-based tests reflect intended behavior.
    newDealBtn?.addEventListener('click', () => window.openNewDealModal?.())
    document
  ...
  test('✓ Cancel closes and clears transient line-item buffer', () => {
    ...
    // Click cancel
    document.querySelector('[data-testid="cancel-btn"]')?.click()
