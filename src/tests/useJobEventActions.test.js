...
describe('useJobEventActions', () => {
  ...
  describe('validateRange passthrough', () => {
    ...
    it('should detect missing start time', () => {
      ...
      const validation = result.current.validateRange(null, '2024-01-20T16:00:00Z')
    ...
    it('should detect missing end time', () => {
      ...
      const validation = result.current.validateRange('2024-01-20T14:00:00Z', null)
    ...
    it('should handle invalid ISO timestamps', () => {
      ...
      const validation = result.current.validateRange('not-a-date', '2024-01-20T16:00:00Z')
  ...
  describe('hook stability', () => {
    it('should maintain stable function references across re-renders when deps do not change', () => {
      ...
      const { result, rerender } = renderHook(({ opts }) => useJobEventActions(opts), {
