...
import { Search, Filter, Clock, AlertCircle, CheckCircle, XCircle, User, Car, Package, DollarSign, FileText, Eye, ArrowUpDown } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-2">Process, review, and resolve customer warranty claims</p>
              </div>
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <div className="text-sm text-gray-600">
                  {filteredAndSortedClaims?.filter(claim => isOverdue(claim))?.length || 0} overdue claims
                </div>
              </div>
            </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm text-gray-900">
                            {claim?.claim_amount ? parseFloat(claim?.claim_amount)?.toFixed(2) : 'N/A'}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
