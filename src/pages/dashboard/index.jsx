            ...
            {topPriority?.kind === 'overdue' ? (() => {
              ...
              return (
                <div className="mb-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm ring-1 ring-lex-urgent/15">
                  {/* Wave J.1a — stack on mobile (flex-col), row on sm+. Removed `truncate`
                      so the headline can wrap when the viewport is narrow instead of clipping. */}
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h2 className="mt-1 font-display text-lg font-semibold text-slate-900 tracking-tight">
                    ...
                    <div className="flex items-center gap-2 shrink-0 sm:self-center">
                      <button
                        ...
                        className="w-full sm:w-auto px-3 py-2 rounded-md bg-lex-brand text-lex-ink-inv hover:bg-lex-brand/90 text-sm font-semibold transition-colors"
                      >
                        Open Overdue Inbox
                      </button>
                    </div>
