        ...
        <div className="mb-6 p-4 bg-muted/50 border border-border rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <Input
              ...
              onChange={(e) =>
                setCustomService((prev) => ({ ...prev, category: e?.target?.value }))
              }
              helperText=""
              maxLength={255}
              style={{}}
              ...
              <div key={service?.id} className="p-4 bg-muted/20 border border-border rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div
                      className={`flex items-center justify-center h-10 px-3 border border-border rounded-lg font-medium text-sm ${
                    ...
                    >
                      $
                      {calculateProfit(service?.cost, service?.price, service?.quantity)?.toFixed(
                        2
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-foreground mb-2">
                      Vendor{' '}
                      {isOffsite && (
                        <Icon name="MapPin" size={12} className="inline text-orange ml-1" />
                      )}
                    </label>
                    <div className="space-y-2">
                      <Select
                        ...
                        onChange={(value) =>
                          handleServiceFieldUpdate(service?.id, 'vendorId', value)
                        }
                      >
                    ...
                    {service?.requiresSchedule && (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Input
                          ...
                          onChange={(e) =>
                            handleServiceFieldUpdate(service?.id, 'startDate', e?.target?.value)
                          }
                          placeholder=""
                          helperText=""
                          maxLength={20}
                ...
                <div className="mt-4">
                  <Input
                    ...
                    value={service?.notes || ''}
                    onChange={(e) =>
                      handleServiceFieldUpdate(service?.id, 'notes', e?.target?.value)
                    }
