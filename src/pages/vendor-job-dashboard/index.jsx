...
const VendorJobDashboard = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 'MSG001',
      sender: 'You',
      content: 'Hi! Job AF-2024-001 has been assigned to you. Please confirm receipt and estimated completion time.',
    ...
    },
    {
      id: 'MSG003',
      sender: 'You',
      content: 'Great! Please update status when you begin work. Customer is expecting Friday delivery.',
  ...
  const stats = {
    ...
    overdueJobs: jobs?.filter(job => new Date(job.dueDate) < new Date() && job?.status !== 'Complete')?.length,
    avgCompletionTime: 18,
    totalJobsChange: 5,
    pendingJobsChange: -2,
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
                  ...
                  <div>
                    <span className="font-mono bg-muted px-2 py-1 rounded">2</span> Mark as In Progress
                  </div>
                  <div>
