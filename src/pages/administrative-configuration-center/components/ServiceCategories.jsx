...
const ServiceCategories = () => {
      ...
      try {
        await logger?.info(
          ...
          `Service categories loaded for management`,
          {
            ...
            totalServices: Object?.values(categories)?.reduce((sum, cat) => sum + cat?.services?.length, 0)
          }
        );
  ...
  const filteredCategories = Object?.entries(categories)?.reduce((acc, [key, category]) => {
    ...
    if (searchTerm === '' || filteredServices?.length > 0) {
      acc[key] = { ...category, services: searchTerm === '' ? category?.services : filteredServices };
    }
    ...
    <div className="p-6">
      ...
      <div className="space-y-6">
        {Object?.entries(filteredCategories)?.map(([categoryKey, category]) => (
          <div key={categoryKey} className={`border rounded-lg ${colorClasses?.[category?.color] || colorClasses?.blue}`}>
            {/* Category Header */}
            <div 
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
                ...
                <>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, categoryIcon: e?.target?.value }))}
                ...
                <>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, serviceActive: e?.target?.checked }))}
                      className="rounded"
                    />
              ...
              <div className="flex space-x-3 pt-4">
                ...
                >
                  {formMode === 'add-category' ?'Add Category'
                    : formMode === 'add' ?'Add Service' :'Update Service'
                  }
                </Button>
                <Button
                  type="button"
