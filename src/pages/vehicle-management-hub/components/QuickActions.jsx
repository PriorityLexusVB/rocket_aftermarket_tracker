      ...
      <div className="mb-4">
        ...
        >
          <div className="flex items-center space-x-4 mb-3">
            <div
              className={`flex items-center justify-center w-12 h-12 rounded-xl ${quickActions?.[0]?.color} group-hover:scale-110 transition-transform duration-200`}
            >
        ...
        {quickActions?.slice(1)?.map((action) => (
          ...
          >
            <div className="flex items-center space-x-3 mb-3">
              <div
                className={`flex items-center justify-center w-10 h-10 rounded-lg ${action?.color} group-hover:scale-110 transition-transform duration-200`}
              >
      ...
      <div className="mt-6 pt-4 border-t border-border">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          ...
          <div className="flex items-center space-x-4">
            <span>
              <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+N</kbd> Add Vehicle
            </span>
            <span>
              <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+F</kbd> Search
            </span>
            <span>
              <kbd className="px-1 py-0.5 bg-muted rounded text-xs">Ctrl+R</kbd> Refresh
            </span>
          </div>
        </div>
      </div>
