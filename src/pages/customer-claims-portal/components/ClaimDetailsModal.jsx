...
import { X, Calendar, DollarSign, User, Car, Package, MessageSquare, FileImage, ExternalLink } from 'lucide-react';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      <p><strong>Name:</strong> {claim?.customer_name || 'N/A'}</p>
                      <p><strong>Email:</strong> {claim?.customer_email || 'N/A'}</p>
                      <p><strong>Phone:</strong> {claim?.customer_phone || 'N/A'}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 space-y-1">
                        ...
                        <p><strong>Owner:</strong> {claim?.vehicle?.owner_name}</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      ...
                      {claim?.resolved_at && (
                        <p><strong>Resolved:</strong> {formatDate(claim?.resolved_at)}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                {claim?.product && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 space-y-1">
                        <p><strong>Product:</strong> {claim?.product?.name}</p>
                        <p><strong>Brand:</strong> {claim?.product?.brand}</p>
                        <p><strong>Category:</strong> {claim?.product?.category}</p>
                      </div>
                    </div>
                  </div>
                )}
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-600">
              ...
              <a href="mailto:claims@priorityautomotive.com" className="text-blue-600 hover:text-blue-700">
