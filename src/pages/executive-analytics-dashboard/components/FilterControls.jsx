      ...
      <div className="mt-4 pt-4 border-t border-border">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            className={productFilter === 'toughguard' ? 'bg-primary/10 border-primary text-primary' : ''}
          >
            Top Product
          </Button>
          ...
          <Button
            ...
            className={vendorFilter === 'premium-auto' ? 'bg-primary/10 border-primary text-primary' : ''}
          >
            Top Vendor
          </Button>
        </div>
