...
const PhotoDocumentationCenter = () => {
  ...
  const filteredPhotos =
    documentation?.photos?.filter((photo) => {
  ...
  const filteredNotes =
    documentation?.notes?.filter((note) => {
      if (
        filters?.searchTerm &&
        !note?.message?.toLowerCase()?.includes(filters?.searchTerm?.toLowerCase())
      )
        return false
      return true
    }) || []
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Visual progress tracking and comprehensive note logging
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-blue-600">
                    {documentation?.totalPhotos || 0}
                  </div>
                  <div className="text-sm text-gray-600">Photos</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-600">
                    {documentation?.totalNotes || 0}
                  </div>
          ...
          {selectedJob ? (
            ...
            <div className="flex-1 flex items-center justify-center text-gray-500">
              <div className="text-center">
                ...
                <p className="text-sm">
                  Choose a job from the sidebar to view and manage photos and notes
                </p>
              </div>
            </div>
          )}
