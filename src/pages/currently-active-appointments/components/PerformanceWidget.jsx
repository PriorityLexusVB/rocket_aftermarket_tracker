        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div
                className={`text-xs font-semibold ${getCompletionRateColor(metrics?.todayCompletionRate || 0)}`}
              >
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div
                className={`text-xs font-semibold ${getCompletionRateColor(metrics?.weekCompletionRate || 0)}`}
              >
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-xs font-semibold text-purple-600">
                {metrics?.weekCompletionRate
                  ? metrics?.weekCompletionRate > 75
                    ? 'Excellent'
                    : metrics?.weekCompletionRate > 60
                      ? 'Good'
                      : 'Needs Improvement'
                  : 'No Data'}
              </div>
