      ...
      if (error) {
        ...
        if (
          ...
          return {
            data: null,
            error: {
              message: 'Session was corrupted and has been reset. Please try signing in again.',
            },
          }
        }
      ...
      if (
        ...
        try {
          ...
          return {
            data: null,
            error: {
              message: 'Authentication service temporarily unavailable. Please refresh the page.',
            },
          }
        }
      }
