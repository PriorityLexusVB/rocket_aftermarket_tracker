  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors duration-200"
      ...
      {isOpen && (
        <>
          ...
          {/* Menu */}
          <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border-2 border-gray-200 py-2 z-40 max-h-96 overflow-y-auto">
            ...
            {Object.entries(availableThemes)?.map(([key, theme]) => (
              <button
                ...
                className={`w-full px-4 py-4 text-left hover:bg-gray-50 transition-colors duration-150 border-l-4 ${
                  currentTheme === key 
