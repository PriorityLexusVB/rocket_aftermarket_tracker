...
const Header = ({ onMenuToggle, isMenuOpen = false }) => {
  ...
  const getBreadcrumbs = () => {
    ...
    const breadcrumbMap = {
      ...
      '/sales-tracker': [{ label: 'Operations', path: '#' }, { label: 'Sales Tracker', path: '/sales-tracker' }],
      '/vehicle-management-hub': [{ label: 'Operations', path: '#' }, { label: 'Vehicle Management', path: '/vehicle-management-hub' }],
      '/vehicle-detail-workstation': [{ label: 'Operations', path: '#' }, { label: 'Vehicle Management', path: '/vehicle-management-hub' }, { label: 'Detail Workstation', path: '/vehicle-detail-workstation' }],
      '/vendor-operations-center': [{ label: 'Management', path: '#' }, { label: 'Vendor Operations', path: '/vendor-operations-center' }],
      '/vendor-job-dashboard': [{ label: 'Management', path: '#' }, { label: 'Vendor Operations', path: '/vendor-operations-center' }, { label: 'Job Dashboard', path: '/vendor-job-dashboard' }],
      '/calendar-scheduling-center': [{ label: 'Operations', path: '#' }, { label: 'Calendar Scheduling', path: '/calendar-scheduling-center' }],
      '/kanban-status-board': [{ label: 'Operations', path: '#' }, { label: 'Kanban Board', path: '/kanban-status-board' }],
      '/sales-transaction-interface': [{ label: 'Management', path: '#' }, { label: 'Sales Transactions', path: '/sales-transaction-interface' }],
      '/business-intelligence-reports': [{ label: 'Reporting', path: '#' }, { label: 'Business Intelligence', path: '/business-intelligence-reports' }],
      '/photo-documentation-center': [{ label: 'Reporting', path: '#' }, { label: 'Photo Documentation', path: '/photo-documentation-center' }],
      '/administrative-configuration-center': [{ label: 'Management', path: '#' }, { label: 'Configuration', path: '/administrative-configuration-center' }]
    };
