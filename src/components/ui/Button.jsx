    ...
    <button
      ...
      className={cn(
        ...
        // H3: Variant styles - only disable pointer events when actually disabled, not for validation
        {
          ...
          'destructive': "bg-destructive text-destructive-foreground hover:bg-destructive/90 h-11 px-4 py-2",
          'outline': "border border-input bg-background hover:bg-accent hover:text-accent-foreground h-11 px-4 py-2",
          'secondary': "bg-secondary text-secondary-foreground hover:bg-secondary/80 h-11 px-4 py-2",
